        ...
        <div className="space-y-10" onClick={() => setOpenMenuId(null)}>
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    ...
                    <p className="text-slate-400 mt-2 font-bold uppercase tracking-widest text-[10px]">Gestionando: {profile.grupoAsignado}</p>
                </div>
                <button
                    ...
                    <table className="w-full text-left border-separate border-spacing-0">
                        ...
                        <tbody className="divide-y divide-slate-50/50">
                                        ...
                                        <div className="flex items-center gap-5">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center gap-2 mt-2">
                                                    ...
                                                    <p className="text-[13px] text-slate-400 font-medium leading-none">{miembro.telefono || 'Sin teléfono'}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                            ...
                            {filteredMiembros.length === 0 && (
                                <tr>
                                    <td colSpan="5" className="px-8 py-32 text-center text-slate-500 font-bold uppercase tracking-widest opacity-30 italic text-sm">
